...
class GenericRequest {
   ...
   * @returns {Promise<HTTPResponse>}
   */
  then (resolver: ((r: HTTPResponse) => any) | null, rejector: ((r: HTTPError) => any) | null): Promise<HTTPResponse> {
    if (this._res) {
   ...
   * @returns {Promise<HTTPResponse>}
   */
  catch (rejector: ((e: HTTPError) => any) | null): Promise<HTTPResponse> {
