...
// const dstRootPath = require('./dst_root_ca_x3.pem');

const dstRoot = readFileSync('/Users/lleyton/Documents/replugged/src/fake_node_modules/powercord/http/dst_root_ca_x3.pem', { encoding: 'utf8' }).trim();

// // Exclude DST Root CA x3 from trust chain
const certificates = tls.rootCertificates.filter((c) => c !== dstRoot);
