import { info as sassInfo } from 'sass';
...
class SCSS extends Compiler {
   ...
   */
  async _resolveDeps (file: string, resolvedFiles: string[] = []) {
  ...
  /** @private */
  _resolveFile (partialFile: string): string | null {
  ...
  /** @private */
  _resolveFile0 (partialFile: string) {
    if (!existsSync(partialFile)) {
