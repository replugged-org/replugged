...
class Compiler extends Events {
  ...
  _watchers: Record<string, ReturnType<typeof watch>>;
  compileOptions: object | undefined;
   ...
   */
  setCompileOptions (options: object) {
    // @todo: finish this
  ...
  /** @private */
  _doCompilation (cacheKey: string | null) {
  ...
  /** @private */
  _finishCompilation (cacheFile: string | null, compiled: string | Buffer) {
    if (cacheFile) {
      writeFileSync(cacheFile, compiled);
    }
   ...
   */
  computeCacheKey (): Promise<string | null> | string | null {
