...
const mod = await waitForModule(filters.bySource("LABEL_SELECTED"), {timeout: 10000}) as ObjectExports;
...
Object.keys(types).forEach((key) => {
  FormText[key] = (props) => (
    <FormTextComp type={types[key]} {...props}>{props.children}</FormTextComp>
  )
})
