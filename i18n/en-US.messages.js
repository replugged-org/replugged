...
export default defineMessages({
  ...
  "REPLUGGED_ADDON_SETTINGS_THEME_SPLASH_PRESET": "Choose Theme Splash Preset",
  "REPLUGGED_TOAST_THEME_SPLASH_PRESET_CHANGED": "Switched to splash preset {name}",
  "REPLUGGED_TOAST_THEME_SPLASH_PRESET_FAILED": "Failed to change splash preset for {name}",
