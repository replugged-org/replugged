...
export default defineMessages({
  ...
  "REPLUGGED_SETTINGS_ADVANCED_NOTICE": "Don't touch stuff in here if you don't know what you're doing. Unexpected things can happen to your cat.",
  ...
  "REPLUGGED_SETTINGS_TRANSPARENCY_BG_MATERIAL_DESC": "Adjust the material effect used for the window background.",
  "REPLUGGED_SETTINGS_TRANSPARENCY_VIBRANCY": "Vibrancy",
  "REPLUGGED_SETTINGS_TRANSPARENCY_VIBRANCY_DESC": "Select the native macOS vibrancy effect applied to the transparent window.",
  ...
  "REPLUGGED_UPDATES_SETTINGS_COLLAPSED": "Show Updater Settings",
  "REPLUGGED_UPDATES_SETTINGS_EXPANDED": "Hide Updater Settings",
  "REPLUGGED_UPDATES_SETTINGS_DESC": "Configure how Replugged checks for updates",
  "REPLUGGED_SETTINGS_ADVANCED_COLLAPSED": "Show Advanced Settings",
  "REPLUGGED_SETTINGS_ADVANCED_EXPANDED": "Hide Advanced Settings",
  "REPLUGGED_SETTINGS_ADVANCED_DESC": "Experiments, development tools and other settings for power users."
});